        ...
        saveRent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fechaRenta.isEmpty() || placa.isEmpty() || stringNumeroRenta.isEmpty()) {
                    Toast.makeText(Rent.this, "Debe ingresar todos los datos", Toast.LENGTH_SHORT).show();
                    return;
                }
                            ...
                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                if (task.isSuccessful()) {
                                    if (task.getResult().isEmpty()) {
                                        ...
                                        Toast.makeText(Rent.this, "Esa placa no existe", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                                                    ...
                                                                    db.collection("rents")
                                                                            ...
                                                                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                                                ...
                                                                                public void onSuccess(DocumentReference documentReference) {
                                                                                    Toast.makeText(Rent.this, "Renta creada con exito. ID : " + documentReference.getId() , Toast.LENGTH_SHORT).show();
                                                                                    db.collection("cars")
                                                                                            .document(idCarFound)
                                                                                            ...
                                                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                ...
                                                                                                public void onSuccess(Void unused) {
                                                                                                    Toast.makeText(Rent.this, "Carro actualizado con exito", Toast.LENGTH_SHORT).show();
                                                                                                }
                                                                                            }).addOnFailureListener(new OnFailureListener() {
                                                                                                @Override
                                                                                                public void onFailure(@NonNull Exception e) {
                                                                                                    Toast.makeText(Rent.this, "No pudimos actualizar los datos del carro", Toast.LENGTH_SHORT).show();
                                                                                                }
                                                                                            });
                                                                                }
                                                                            }).addOnFailureListener(new OnFailureListener() {
                                                                                @Override
                                                                                public void onFailure(@NonNull Exception e) {
                                                                                    Toast.makeText(Rent.this, "No se pudo grabar la renta", Toast.LENGTH_SHORT).show();
                                                                                }
                                                                            });
                                                                } else {
                                                                    Toast.makeText(Rent.this, "Ese numero de renta ya existe. Escoja otro.", Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        }
                                                    });
                                        } else {
                                            Toast.makeText(Rent.this, "El carro no está disponible", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
                            }
